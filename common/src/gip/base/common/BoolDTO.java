 ...
 */
public class BoolDTO extends OBDTO implements OBDTOInterface {

  private static final long serialVersionUID = 5081730022883704490L;
  public long getCapabilityId() { return OBAttribute.NULL;}
  ...
  public void setBool(boolean b) { this.value = b; }
