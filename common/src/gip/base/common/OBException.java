...
public class OBException extends Exception implements Serializable {
  ...
  /** 
   * The error category describes wether the system is consisten or not after the occurence of the error 
   ...
   */
  protected int errorCategory = Category.ne_consistent;  // Default: nach Fehler ist das System dennoch konsistent
  ...
  // "neue" Fehlerbehandlung: Fehlercategory: System ist nach Fehler konsistent (Default) oder nicht
  public interface Category {
    public static final int ne_consistent = 1;
    public static final int ne_not_consistent = 2;
  }
  ...
  /**
   * erweitertert Standard Konstuktor (mit errorCategory und errorDetails
   * @param errCat
   * @param errNo
   * @param errMsg
   * @param errDetails 
   */
  public OBException(int errCat, int errNo, String errMsg, String errDetails) {
    super(errMsg);
    this.errorCategory = errCat;
    this.errorNo = errNo;
   ...
   * @param errMsg
   */
  public OBException(int errNo, String errMsg) {
    this(Category.ne_consistent, errNo, errMsg, "");
  }
  
  /**
   * Standard Konstruktor mit errorDetails
   * @param errNo 
   * @param errMsg 
   * @param errDetails 
   */
  public OBException(int errNo, String errMsg, String errDetails) {
    this(Category.ne_consistent, errNo, errMsg, errDetails);
  }
  
  
  /**
   * Um errNo erweiterter Konstruktor fuer error Messages aus den DTOs
   * @param errNo
   * @param s
   * @param toReplace
   */
  public OBException(int errNo, String s, String[] toReplace) {
  ...
  */
  ...
  public void setErrorCategory(int errCat) {
    this.errorCategory = errCat;
  }
  ...
  public void setErrorDetails(String errDetails) {
    this.errorDetails = errDetails;
  }
