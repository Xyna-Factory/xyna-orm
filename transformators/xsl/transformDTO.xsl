...
<xsl:text>  /** Interface mit den moeglichen Capabilities */
  public interface PosCap extends Serializable {
    ...
    public final static long find                 = </xsl:text><xsl:value-of select="@id"/><xsl:text>00+01L;
    public final static long findPK               = </xsl:text><xsl:value-of select="@id"/><xsl:text>00+02L;
    public final static long findFilter           = </xsl:text><xsl:value-of select="@id"/><xsl:text>00+03L;
    public final static long findWC               = </xsl:text><xsl:value-of select="@id"/><xsl:text>00+04L;
    /** @deprecated Bitte nicht benutzen, wird nur von der Benutzerverwaltung verwendet */
    public final static long findAll              = </xsl:text><xsl:value-of select="@id"/><xsl:text>00+10L;
    public final static long findAllPKs           = </xsl:text><xsl:value-of select="@id"/><xsl:text>00+11L;
    public final static long findAllFilter        = </xsl:text><xsl:value-of select="@id"/><xsl:text>00+12L;
    public final static long findAllWC            = </xsl:text><xsl:value-of select="@id"/><xsl:text>00+13L;
    /** @deprecated Bitte nicht benutzen, wird nur von der Benutzerverwaltung verwendet */
    public final static long count                = </xsl:text><xsl:value-of select="@id"/><xsl:text>00+20L;
    public final static long countPKs             = </xsl:text><xsl:value-of select="@id"/><xsl:text>00+21L;
    public final static long countFilter          = </xsl:text><xsl:value-of select="@id"/><xsl:text>00+22L;
    public final static long countWC              = </xsl:text><xsl:value-of select="@id"/><xsl:text>00+23L;
</xsl:text>
<xsl:for-each select="Capability">

<xsl:if test="@type='DELETE'"><xsl:text>
    public final static long delete               = </xsl:text><xsl:value-of select="../@id"/><xsl:text>00+30L;
    public final static long findAndDeletePKs     = </xsl:text><xsl:value-of select="../@id"/><xsl:text>00+31L;
    public final static long findAndDeleteFilter  = </xsl:text><xsl:value-of select="../@id"/><xsl:text>00+32L;
    public final static long findAndDeleteWC      = </xsl:text><xsl:value-of select="../@id"/><xsl:text>00+33L;
    public final static long findAndDeleteList    = </xsl:text><xsl:value-of select="../@id"/><xsl:text>00+34L;
    public final static long setLock              = </xsl:text><xsl:value-of select="../@id"/><xsl:text>00+36L;
    public final static long getLock              = </xsl:text><xsl:value-of select="../@id"/><xsl:text>00+37L;
    public final static long resetLock            = </xsl:text><xsl:value-of select="../@id"/><xsl:text>00+38L;    
</xsl:text></xsl:if>
<xsl:if test="@type='NOTIFY'"><xsl:text>
    public final static long notifyTk             = </xsl:text><xsl:value-of select="../@id"/><xsl:text>00+35L;

</xsl:text>
</xsl:if>
</xsl:for-each>
<xsl:for-each select="Capability">
<xsl:if test="(@id&gt;99 or @id&lt;39) and not(@forceId='Y')">
