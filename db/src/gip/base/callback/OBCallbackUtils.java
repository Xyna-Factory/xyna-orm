...
public class OBCallbackUtils {
  ...
  static {
    ...
    OBException.addErrorMessage(inputToLong2(),"Der Inhalt des Feldes {0} darf hoechstens {1} Zeichen lang sein."); //$NON-NLS-1$
    ...
    OBException.addErrorMessage(inputToLong3(),"Der Inhalt des Feldes {0} darf hoechstens {1} Zeilen enthalten."); //$NON-NLS-1$
  }
