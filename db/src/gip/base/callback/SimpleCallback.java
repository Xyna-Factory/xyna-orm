...
public interface SimpleCallback extends Remote {
  ...
  public void openCCBReportForm(String title, long key, int mode, int menuType, String bericht, String ss, String hsList, String className) throws RemoteException;
}
