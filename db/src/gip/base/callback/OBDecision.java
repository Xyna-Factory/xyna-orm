...
abstract public class OBDecision extends Object implements java.io.Serializable {
  ...
  /**
   * Liefert true oder false als Entscheidung zurueck
  ...
  /**
   * Liefert die Entscheidung als String zurueck, 
   * nuetzlich bei mehreren Wahlmoeglichkeiten.
   * @return Entscheidung
   */
  ...
  /**
   * Liefert nur eine Warnung, die i.d.R. bestaetigt werden muss,
   * die abgeleiteten Klassen muessen damit entsprechen umgehen. 
   */
   ...
   * die Default-Answer zurueckgeliefert.
   * @return Wert
   */
   ...
   * Desweiteren wird das Objekt zurueckgesetzt.
  ...
  /**
   * Setzt eine Menge von Entscheidungsmoeglichkeiten.
  ...
  /**
   * Setzt die primaere DefaultAnswer die von 
  ...
  /**
   * Liefert die moeglichen Entscheidungen.
