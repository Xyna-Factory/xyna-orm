...
public class SimpleCallbackRMI extends UnicastRemoteObject implements SimpleCallback {
   ...
   */
  public void openCCBReportForm(String title, long key, int mode, int menuType, String bericht, String ss, String hsList, String className) {
    try {
      Class<?> cls_CCBReportForm = Class.forName(className);//$NON-NLS-1$
